    ...
    */
    return queryInterface.bulkInsert(
      ...
      [
        {
          content:
            "I absolutely do not. \r\n Every bit of 'evidence' I've seen has a perfectly natural explanation, is the result of people seeing what they want to see or hear what they want to hear, or outright fakery and manipulation. \r\n As with 'exorcists' and 'demon experts,' the 'ghosthunters' are deluded at best and after your money at worst.",
          userId: 1,
          questionId: 1,
        ...
        {
          content:
            "Because I have had encounters with ghosts. Plural. I know what I experienced and cannot explain them as anything else.",
          userId: 2,
          questionId: 1,
        ...
        {
          content:
            "You don't, because not all spirits are going to be friendly towards you. The spirit you should connect with is the spirit of God, as he will minister to you.",
          userId: 5,
          questionId: 3,
        ...
        {
          content:
            "Get to know yourself. Seriously, remember that old teaching about omnipresence? Spirit is everywhere, and it is you.",
          userId: 6,
          questionId: 3,
        ...
        {
          content:
            "Occasionally some prankster will fool some scientists with basic tricks - until they contact a stage magician and get it sorted out. Then there's a long period of whining about how it's not fair to expect the paranormal to face actual scrutiny.",
          userId: 7,
          questionId: 4,
        ...
        {
          content:
            "The closest thing to proving abilities and paranormal phenomena is parapsychology. The only way to 'verify' it is for you to see it yourself… Reading legit reviews from a reputable source.I am verified legit when it comes to my psychic abilities ( I have a link to the website on my FB page) I have numerous people that can attest to my abilitiesIt is all word of mouth. There is no legit scientific way you could explain what I knew/know except for Reviews and speaking to the source to which I was involved with.",
          userId: 8,
          questionId: 4,
        ...
        {
          content:
            "No, because you have to be a U.S. citizen to be able to be employed into Area 51, and nobody can enter unless they work there. Oh, you meant extraterrestrial aliens? Sorry, there aren't any of those at Area 51 either. And there never will be.",
          userId: 1,
          questionId: 5,
        ...
        {
          content: "They can not but an evil Human can act an be evil like one",
          userId: 5,
          questionId: 6,
